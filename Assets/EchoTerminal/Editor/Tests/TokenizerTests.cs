...
public class TokenizerTests
{
	...
	{
		Assert.AreEqual(expected, Tokenizer.Tokenize(input, _parsers)[index].Raw);
	}
	...
	{
		Assert.AreEqual(expected, Tokenizer.Tokenize(input, _parsers)[index].Type);
	}
	...
	{
		Assert.AreEqual(expected, Tokenizer.Tokenize(input, _parsers)[index].State);
	}
